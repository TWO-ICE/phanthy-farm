...
```json
{
  ...
  "style": {
    "background": "extracted and softly blurred from reference image, 50% blur, warm cream/ivory tone with subtle yarn texture",
    "mood": "warm, healing, handcraft knitting aesthetic, cozy craft workshop vibe, gentle and inviting",
    "color_grade": "cream white + warm beige + soft pink, low saturation, film grain texture, warm soft tone",
  ...
  "composition": {
    ...
    "decorative_elements": "subtle yarn/crochet texture overlay on edges, no watermarks, no icons"
  },
