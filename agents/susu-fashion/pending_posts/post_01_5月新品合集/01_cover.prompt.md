...
> **占位符**: `5月新品合集` / `一针一线的初夏，藏进这座小花园` / `新品85折` 已预填
...
```json
{
  ...
  "style": {
    ...
    "mood": "warm, healing, slow-life handcraft aesthetic, cozy Jiangnan craft workshop vibe with garden inspiration, NOT urgent or clickbait",
    "color_grade": "cream white + oatmeal + dried rose pink + sage green, low saturation, film grain texture, warm soft tone",
  ...
  "text": {
    ...
    "price_tag": {
      ...
      "size": "large",
      "color": "warm brown text on cream beige (#F5E6D3) rectangular badge with rounded corners and thin brown border",
  ...
  "composition": {
    ...
    "decorative_elements": "subtle linen/canvas texture overlay on edges (top-left + bottom-right), no watermarks, no icons, optional dried flower sprig in corner"
  },
