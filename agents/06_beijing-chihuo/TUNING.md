# TUNING.md — 北京吃货小分队（beijing-chihuo）
...
| 决策 | 理由 |
|---|---|
| Swiss 而非 Editorial | 北京吃货小分队是**快节奏新闻速报**，需要工程冷感而非慢阅读杂志感 |
| IKB Blue | 国际克莱因蓝是科技/AI/工程领域的默认色，与华为/5G/芯片等内容天然匹配 |
| C09 声明式封面 | 科技新闻标题本身就是观点（"华为没有对手""苹果紧急回应"），适合大字声明式排版 |
| 标题 ≤20 字 | 北京吃货小分队标题偏长（平均 18-22 字），取核心观点压缩到 20 字 |
...
北京吃货小分队原标题常超 20 字，喂给封面前必须压缩。规则：
